...
func TestVNextOwnerAuthorizationPolicyIsFailClosed(t *testing.T) {
	tests := []struct {
		...
		{vnextOwnerCallerScheduler, vnextOwnerRPCOperationReclaim, true},
		{vnextOwnerCallerScheduler, vnextOwnerRPCOperationReclaimStatusAndFence, true},
		...
		{vnextOwnerCallerProducer, vnextOwnerRPCOperationReclaim, false},
